...
INSTANTIATE_TEST_SUITE_P(
    ...
    ::testing::Values(
        ...
        new TestParams(PERFT_FEN_POSITION_2_BLACK, 46, 38, BPawn),
        new TestParams(PERFT_FEN_POSITION_2, 14, 23, WPawn),
        new TestParams(PERFT_FEN_POSITION_2_BLACK, 25, 18, BPawn),
        new TestParams(PERFT_FEN_POSITION_2, 4, 6, WKing),
        new TestParams(PERFT_FEN_POSITION_2, 4, 2, WKing),
        new TestParams(PERFT_FEN_POSITION_2_BLACK, 60, 62, BKing),
        new TestParams(PERFT_FEN_POSITION_2_BLACK, 60, 58, BKing),
